...
PROJECT_DIR="/var/www/html/_bases/base_techplanner_fila3_mono"
...
show_help() {
    echo "Utilizzo: /var/www/html/_bases/base_techplanner_fila3_mono/bashscripts/mcp/mcp-manager-v2.sh [comando] [server]"
    echo ""
    ...
    echo ""
    echo "Esempi:"
    echo "  /var/www/html/_bases/base_techplanner_fila3_mono/bashscripts/mcp/mcp-manager-v2.sh start mysql    - Avvia il server MCP MySQL"
    echo "  /var/www/html/_bases/base_techplanner_fila3_mono/bashscripts/mcp/mcp-manager-v2.sh start          - Avvia tutti i server MCP"
    echo "  /var/www/html/_bases/base_techplanner_fila3_mono/bashscripts/mcp/mcp-manager-v2.sh status         - Mostra lo stato di tutti i server MCP"
}
...
ALL_SERVERS=("sequential-thinking" "memory" "fetch" "filesystem" "puppeteer" "mysql")
