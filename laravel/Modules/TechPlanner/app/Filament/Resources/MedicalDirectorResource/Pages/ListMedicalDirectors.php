...
class ListMedicalDirectors extends XotBaseListRecords
{
    ...
    {
        return [
            Tables\Filters\SelectFilter::make('created_at')->options(
                MedicalDirectorResource::getModel()::selectRaw('DATE(created_at) as date')
                    ->distinct()
                    ->pluck('date', 'date')
                    ->toArray(...),
            ),
    ...
    protected function getHeaderActions(): array
    {
        ...
        $actions = [
            ...
            Actions\ImportAction::make('importMedicalDirector')->importer(MedicalDirectorImporter::class),
        ];
