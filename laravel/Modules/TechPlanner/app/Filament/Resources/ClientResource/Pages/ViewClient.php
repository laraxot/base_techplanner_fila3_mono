...
class ViewClient extends XotBaseViewRecord
{
    ...
    {
        return [
            \Filament\Infolists\Components\Section::make('Company Information')->schema([
            ...
            \Filament\Infolists\Components\Section::make('Contact Information')->schema([
            ...
            \Filament\Infolists\Components\Section::make('Additional Information')->schema([
