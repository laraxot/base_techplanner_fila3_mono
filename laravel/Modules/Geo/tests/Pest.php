...
expect()->extend('toBeCountry', fn () => $this->toBeInstanceOf(\Modules\Geo\Models\Country::class));

expect()->extend('toBeRegion', fn () => $this->toBeInstanceOf(\Modules\Geo\Models\Region::class));

expect()->extend('toBeCity', fn () => $this->toBeInstanceOf(\Modules\Geo\Models\City::class));
