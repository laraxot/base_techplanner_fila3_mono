...
<!-- Simple tooltip -->
<x-bootstrap-italia.tooltip text="This is a tooltip">
    <button class="btn btn-primary">Hover me</button>
</x-bootstrap-italia.tooltip>

<!-- Tooltip with positioning -->
<x-bootstrap-italia.tooltip text="Tooltip on the right" position="end">
    <span class="text-primary">Info</span>
</x-bootstrap-italia.tooltip>

<!-- Tooltip with click trigger -->
<x-bootstrap-italia.tooltip text="Click to show" trigger="click">
    <button class="btn btn-outline-primary">Click tooltip</button>
</x-bootstrap-italia.tooltip>

<!-- Tooltip with delay -->
<x-bootstrap-italia.tooltip text="Tooltip with delay" :delay="500">
    <svg class="icon icon-sm text-primary">
        <use href="#it-info-circle"></use>
    </svg>
</x-bootstrap-italia.tooltip>
...
<x-bootstrap-italia.tooltip text="Automatic info icon tooltip" />
--}}
