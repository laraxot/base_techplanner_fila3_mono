...
<!-- Popover semplice -->
<x-bootstrap-italia.popover title="Informazioni">
    <x-slot name="trigger">
...
<x-bootstrap-italia.popover title="Menu azioni" position="right" size="lg">
    <x-slot name="trigger">
...
<x-bootstrap-italia.popover title="Dettagli utente" trigger="hover" theme="dark">
    <x-slot name="trigger">
...
<x-bootstrap-italia.popover title="Importante" :dismissible="false">
    <x-slot name="trigger">
...
<x-bootstrap-italia.popover title="Form rapido" width="w-80">
    <x-slot name="trigger">
