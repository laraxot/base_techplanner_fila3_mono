...
<!-- Link semplice -->
<x-bootstrap-italia.dropdown-item href="/profilo">
    Il mio profilo
</x-bootstrap-italia.dropdown-item>

<!-- Link con icona -->
<x-bootstrap-italia.dropdown-item href="/settings" icon="heroicon-o-cog-6-tooth">
    Impostazioni
</x-bootstrap-italia.dropdown-item>

<!-- Button con azione JavaScript -->
<x-bootstrap-italia.dropdown-item icon="heroicon-o-arrow-right-on-rectangle" variant="danger">
    Logout
</x-bootstrap-italia.dropdown-item>

<!-- Item disabilitato -->
<x-bootstrap-italia.dropdown-item disabled>
    Funzione non disponibile
</x-bootstrap-italia.dropdown-item>

<!-- Item attivo -->
<x-bootstrap-italia.dropdown-item href="/dashboard" active>
    Dashboard
</x-bootstrap-italia.dropdown-item>

<!-- Link esterno -->
<x-bootstrap-italia.dropdown-item href="https://example.com" target="_blank" icon="heroicon-o-arrow-top-right-on-square">
    Link esterno
</x-bootstrap-italia.dropdown-item>
--}}